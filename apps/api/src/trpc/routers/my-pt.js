...
import { getAiSystemPrompt, getMessages, checkOnboardingCompletion, } from "../../drizzle/src/db/queries";
import { insertAiSystemPrompt, updateAiSystemPrompt, } from "../../drizzle/src/db/mutations";
        ...
        try {
            ...
            if (!isCompleted) {
                throw new TRPCError({
                    ...
                    message: "Please complete your onboarding first to use the AI trainer.",
                });
            }
            // Build user context
