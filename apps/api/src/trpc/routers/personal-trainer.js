...
import { getPersonalTrainerInteractions, getPersonalTrainerInteraction, } from "../../drizzle/src/db/queries";
...
export const personalTrainerRouter = createTRPCRouter({
    ...
    getInteractions: protectedProcedure
        ...
        try {
            return await getPersonalTrainerInteractions(ctx.userId, input.limit, input.cursor ?? undefined);
        }
        catch (error) {
