...
import { PILATES_APPARATUS, PILATES_DURATION, PILATES_SESSION_PREFERENCE, CUSTOM_PILATES_APPARATUS } from "@/app/_constants/pilates";
                            ...
                            <div className="mt-4 flex flex-col gap-2">
                                <div className="flex gap-2">
                                    <Input
                                        ...
                                        className={`flex-1 rounded-md text-sm shadow-sm focus:ring-indigo-500 ${errors.otherApparatusPreferences
                                ...
                                <div className="mt-4 flex flex-col gap-2">
                                    <div className="flex gap-2">
                                        <Input
                                            ...
                                            type="text"
                                            placeholder="Add apparatus"
                                            className={`flex-1 rounded-md text-sm shadow-sm focus:ring-indigo-500 ${errors.otherCustomApparatus
                                                ? "border-red-500 focus:border-red-500"
                                                : "border-gray-300 focus:border-indigo-500"
                                                }`}
                                        />
